                        ...
                        <div style={{ display: 'flex', gap: '8px' }}>
                          ...
                          {xp && (
                            <div style={colStyle}>
                              ...
                              {Boolean(xp.artBoost) && <Row label={`Арт. +${String(xp.artBoost)}%`} value={`→ ${String(xp.afterArt)}`} dim />}
                              ...
                              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                ...
                                <span style={{ fontSize: '0.78rem', fontWeight: 800, color: 'var(--accent-xp)' }}>+{String(xp.final)} XP</span>
                              </div>
                            </div>
                          )}
                        ...
                        {gold && (
                          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.03)', borderRadius: '8px', padding: '6px 10px' }}>
                            ...
                            {Boolean(gold.artBoost) && (
                              <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>арт. +{String(gold.artBoost)}%</span>
                            )}
