...
const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://gjezmurskhjngbostltn.supabase.co';
const supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || 'REMOVED_SECRET'; // Hardcoded for test environment temporarily
