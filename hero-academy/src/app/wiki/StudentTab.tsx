          ...
          <div className={styles.mechanicList}>
            ...
            <div className={styles.mechanicItem}>
              ...
              <div>
                ...
                <p>Получай XP на каждом уроке математики, чтобы растить свой <strong>Стрик 🔥</strong>. Считаются только дни математики (Пн/Ср/Чт/Пт) — вторник, выходные и праздники стрик не сбрасывают. За серии <strong>3, 6, 10 и 14</strong> дней Система выдаст огромную гору опыта и бесплатные Лутбоксы — вплоть до Легендарного на 14-й день.</p>
              </div>
            </div>
