...
const ACTION_LABELS: Record<string, { icon: string; label: string; color: string }> = {
  ...
  quest_graded: { icon: '📝', label: 'Задание оценено', color: '#22c55e' },
  damage: { icon: '💔', label: 'Урон', color: '#ef4444' },
  grant_xp: { icon: '⭐', label: 'Начисление XP', color: '#eab308' },
  grant_gold: { icon: '💰', label: 'Начисление золота', color: '#f59e0b' },
  boss_damage: { icon: '🐉', label: 'Удар по боссу', color: '#f43f5e' },
  boss_kill_reward: { icon: '👑', label: 'Награда за босса', color: '#fbbf24' },
  level_up: { icon: '🆙', label: 'Повышение уровня', color: '#22d3ee' },
  ...
  seasonal_lootbox_opened: { icon: '🎁', label: 'Сезонный лутбокс', color: '#22d3ee' },
  shop_purchase: { icon: '🛒', label: 'Покупка в магазине', color: '#f97316' },
  hp_regen: { icon: '💚', label: 'HP восстановлено', color: '#22c55e' },
  passive_regen: { icon: '💚', label: 'Пассивная регенерация', color: '#22c55e' },
  streak_bonus: { icon: '🔥', label: 'Бонус за стрик', color: '#ef4444' },
  streak_reward: { icon: '🔥', label: 'Награда за стрик', color: '#ef4444' },
  streak_update: { icon: '🔥', label: 'Обновление стрика', color: '#ef4444' },
  class_artifact_used: { icon: '✨', label: 'Классовый артефакт', color: '#a78bfa' },
  team_artifact_activated: { icon: '🛡️', label: 'Командный артефакт', color: '#a78bfa' },
  bp_reward_claimed: { icon: '🎫', label: 'Battle Pass — награда', color: '#facc15' },
