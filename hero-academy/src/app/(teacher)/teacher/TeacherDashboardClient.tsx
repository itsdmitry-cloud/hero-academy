...
import type { TeacherInitialData } from '@/lib/teacher/types';
...
export default function TeacherDashboardClient({ initialData }: { initialData: TeacherInitialData }) {
  useAuth();
  const { classes, activeClassId, students, quests, stats, loading, subjects, activeSubject } = useTeacherData(initialData);
